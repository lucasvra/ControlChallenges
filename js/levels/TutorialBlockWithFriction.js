...
Levels.TutorialBlockWithFriction = function()
{
    ...
    this.description = "Empurre o bloco para baixo da seta (x=0) e faça-o parar ali. Escreva uma função <u>JavaScript</u> que calcule a força horizontal no bloco necessária para isso.";
