...
Levels.RocketLandingNormal = function()
{
    ...
    this.description = "Pouse o foguete na zona de aterrissagem cujo centro é (x, y) = (0, 0). Controle o foguete calculando o empuxo (0 a 1) e o ângulo do motor (−0,2 a 0,2 rad). O foguete tem razão empuxo/peso de 2, então throttle 0,5 o mantém pairando. Aterre suavemente (menos de 5 m/s).";
