...
Levels.TutorialBlockOnSlope = function()
{
    ...
    this.description = "Empurre o bloco para baixo da seta (x=0) e faça-o parar ali. Calcule a força horizontal necessária. Desta vez o bloco está em uma rampa; o controlador PD sozinho não funcionará.";
