...
Levels.MultirotorIntro = function()
{
    ...
    this.title = "Introdução ao Multirotor";
    ...
    this.description = "Controle o multirotor calculando a força de cada rotor. Voe até o quadrado verde e pare lá. Todas as coordenadas (x,y,theta) devem convergir para zero.";
