...
Levels.MultirotorObstacles = function()
{
    ...
    this.title = "Multirotor Obstáculos";
    ...
    this.description = "Mesmas regras da introdução. Além disso, não toque nas paredes!<br/><br/>Dica: isto pode ser útil: <pre>[{x:-2,y:0},{x:-1,y:0},{x:-1,y:2},{x:0,y:2},{x:0,y:0}]</pre>";
