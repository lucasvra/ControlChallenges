...
Levels.StabilizeSinglePendulum = function()
{
    ...
    this.title = "Pêndulo Invertido: Estabilizar";
    ...
    this.description = "Estabilize o pêndulo para que fique em pé, mova-se para o centro (x=0) e permaneça lá em equilíbrio. Calcule a força horizontal no carrinho necessária para isso.";
