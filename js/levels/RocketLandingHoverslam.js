...
Levels.RocketLandingHoverslam = function()
{
    ...
    this.title = "Pouso de Foguete Hoverslam";
    ...
    this.description = "Neste nível o foguete não consegue pairar porque os motores não podem reduzir tanto a potência. A razão empuxo/peso varia de 1,2 a 2 (throttle de 0,6 a 1).";
